...
public class MainClass {
	...
	public static void main(String[] args) {
		 ...
		 * rect메서드는 빗변을 매개값으로 받아 정사각형의 넓이, 직사각형의 넓이, 직육면체의 넓이를 반환하도록 오버로딩
		 */

		Calculator cal = new Calculator();
		System.out.println("계산기로 계산한 원의넓이:" + cal.circle(4));
		
		
		Computer com = new Computer();
		System.out.println(com.add(5));
		System.out.println(com.sub(2));
		System.out.println("컴퓨터로 계산한 원의넓이:" + com.circle(4));
		
		System.out.println(com.rect(4));
		System.out.println(com.rect(4, 6));
